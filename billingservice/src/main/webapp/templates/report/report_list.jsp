    ...
    <form action="" method="">
        ...
        <div class="layui-col-md12">
            ...
            <div class="active">
                ...
                <div class="layui-inline"><input type="button" value="返回" class="layui-btn" onclick="location.href='bill_list.jsp'" /></div>
            </div>
        </div>
...
<script type="text/html" id="barDemo">
		<a class="layui-btn layui-btn-xs" lay-event="show">账务报表</a>
        <a class="layui-btn layui-btn-xs" lay-event="pay">业务报表</a>
	</script>
...
<script>
    ...
    layui.use('table', function() {
        ...
        table.on('tool(demo)', function(obj) {
            var data = obj.data;
            console.info(data.userInfo.userReallName)
            if (obj.event === 'show') {
                // /accountmag/delete?id="+JSON.stringify(data.id);
                var index = layui.layer.open({
                    title : "账务报表",
                    type : 2,
                    content : "accountechart.jsp?userRealName=" + data.userInfo.userReallName,//弹出层页面
                    area: ['600px', '600px'],
                ...
                var index2 = layui.layer.open({
                    title : "业务报表",
                    type : 2,
                    content : "businessechart.jsp?id=" + data.id,//弹出层页面
                    area: ['600px', '600px'],
                    success : function(layero, index){
